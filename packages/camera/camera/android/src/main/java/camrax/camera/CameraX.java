...
import io.flutter.plugins.camera.CameraZoom;
...
public class CameraX {
  ...
  public final SurfaceTextureEntry flutterTexture;
  ...
  public void initFps(CameraCharacteristics cameraCharacteristics) {
    try {
  ...
  public void createCaptureSession(int templateType, Surface... surfaces)
      throws CameraAccessException {
  ...
  public void createCaptureSessionWithSessionConfig(
  ...
  public void refreshPreviewCaptureSession(
  ...
  public void writeToFile(ByteBuffer buffer, File file) throws IOException {
  ...
  public final CaptureCallback pictureCaptureCallback =
      new CaptureCallback() {
        @Override
        ...
        public void processCapture(CaptureResult result) {
  ...
  public void runPictureAutoFocus() {
  ...
  public void lockAutoFocus(CaptureCallback callback) {
    captureRequestBuilder.set(
  ...
  @TargetApi(VERSION_CODES.P)
  public boolean supportsDistortionCorrection() throws CameraAccessException {
  ...
  public Size getRegionBoundaries() throws CameraAccessException {
  ...
  public boolean isExposurePointSupported() throws CameraAccessException {
  ...
  public boolean isFocusPointSupported() throws CameraAccessException {
    Integer supportedRegions =
        cameraManager
            .getCameraCharacteristics(cameraDevice.getId())
  ...
  public void updateFocus(FocusMode mode) {
    if (useAutoFocus) {
  ...
  public void updateExposure(ExposureMode mode) {
    exposureMode = mode;
  ...
  public void updateFlash(FlashMode mode) {
    // Get flash
    flashMode = mode;
  ...
  public void setImageStreamImageAvailableListener(final EventChannel.EventSink imageStreamSink) {
