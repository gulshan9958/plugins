...
final class CameraPermissions {
    ...
    void requestPermissions(
        ...
        if (!hasCameraPermission(activity) || (enableAudio && !hasAudioPermission(activity))) {
            permissionsRegistry.addListener(
                    new CameraRequestPermissionsListener(activity,
    ...
    static final class CameraRequestPermissionsListener
        ...
        @VisibleForTesting
        CameraRequestPermissionsListener(Activity activity, ResultCallback callback) {
        ...
        public boolean onRequestPermissionsResult(int id, String[] permissions, int[] grantResults) {
            ...
            if (grantResults[0] != PackageManager.PERMISSION_GRANTED) {
                ...
                if (showRationale) {
                    ...
                    callback.onResult("cameraPermission", "MediaRecorderCamera permission not granted and disabled");
                }
